...
public class FavoriteBooksController {
	...
	public List<BookDetails> getAllBookRec(HttpServletRequest req) {
		return bookKeeperService.getAllBookRec(req);
	}


	@PostMapping("/saveRec")
	public void SaveBookRec(@RequestBody BookDetails bookdetails, HttpServletRequest req) {
		bookKeeperService.saveBookRec(bookdetails, req);
	}
}